              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    $ordencompras = ControladorCompras::ctrMostrarOrdenCompra($item, $valor);

                    if(!$ordencompras){

                      echo '<input type="text" class="form-control" id="nuevaOrdenCompra" name="nuevaOrdenCompra" value="10001" readonly>';
                      ...
                      echo '<input type="text" class="form-control" id="nuevaOrdenCompra" name="nuevaOrdenCompra" value="'.$codigo.'" readonly>';
  ...
  <!--======================================
    ...
    =======================================-->
                <div class="form-group row">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoFormaPago" name="nuevoFormaPago" required>
                        ...
                        <option value="Q">15 Dias</option>
                        <option value="M">1 Mes</option>                  
                      </select>    
                  ...
                  <div class="cajasFormaPago"></div>

                  <input type="hidden" id="listaFormaPago" name="listaFormaPago">
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right">Guardar Orden Compra</button>
        ...
        <?php
          ...
          $guardarOrdenCompra = new ControladorCompras();
